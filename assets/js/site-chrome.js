...
(function () {
  ...
  function footerHtml() {
    return (
      ...
      '            <a href="tel:+6287832011500">0878 3201 1500</a>' +
      '          </li>' +
      '          <li class="footer-social">' +
      '            <a href="#" aria-label="Instagram"><svg data-icon viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" /></svg></a>' +
      '            <a href="#" aria-label="Threads"><svg viewBox="0 0 440 511.43" fill="currentColor"><path fill-rule="nonzero" d="' + THREADS_PATH + '" /></svg></a>' +
      '          </li>' +
      '        </ul>' +
      '      </div>' +
      '    </div>' +
